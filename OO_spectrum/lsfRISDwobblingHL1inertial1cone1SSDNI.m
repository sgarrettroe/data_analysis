classdef lsfRISDwobblingHL1inertial1cone1SSDNI < lineshapeFunction
    
    properties
        params = struct('Delta_cm',[],'theta0_deg',[],'tr1',[],'theta1_deg',[],'T2',[],'ampSSD',[],'tauSSD',[]);
        g;
        c2;
        order;
        tpoints;
    ...
    methods
        ...
        function obj = lsfRISDwobblingHL1inertial1cone1SSDNI(params,str,aRFoptions) %constructor function
            if nargin == 0
                super_args = {};
            elseif nargin == 1 
