classdef lsfRISDwobbling1diffNI < lineshapeFunction
    
    properties
        params = struct('Delta_cm',[],'tr1',[]);
        g;
        c2;
        order;
        tpoints;
    ...
    methods
        ...
        function obj = lsfRISDwobbling1diffNI(params,str,aRFoptions) %constructor function
            if nargin == 0
                super_args = {};
            elseif nargin == 1 
        ...
        function obj = makeL_l(obj)
            ...
            for l = 1:4
                %Ctot{l} = 1;
                %for ii = 1:ncones
                Ctot{l}=@(t,p) exp(-(l*(l+1)./(6.*p.tr1)).*t);
                %end
            end
