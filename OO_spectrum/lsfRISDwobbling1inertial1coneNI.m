classdef lsfRISDwobbling1inertial1coneNI < lineshapeFunction
    
    properties
        params = struct('Delta_cm',[],'theta0_deg',[],'tr1',[],'theta1_deg',[]);
        g;
        c2;
        order;
        tpoints;
    ...
    methods
        ...
        function obj = lsfRISDwobbling1inertial1coneNI(params,str,aRFoptions) %constructor function
            if nargin == 0
                super_args = {};
            elseif nargin == 1 
