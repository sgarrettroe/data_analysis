classdef lsfRISDwobblingHL1diff1SSDNI < lineshapeFunction
    
    properties
        params = struct('Delta_cm',[],'tr1',[],'T2',[],'ampSSD',[],'tauSSD',[]);
        g;
        c2;
        order;
        tpoints;
    ...
    methods
        ...
        function obj = lsfRISDwobblingHL1diff1SSDNI(params,str,aRFoptions) %constructor function
            if nargin == 0
                super_args = {};
            elseif nargin == 1 
