classdef lsfRISDwobbling1inertialNI < lineshapeFunction
    
    properties
        params = struct('Delta_cm',[],'theta0_deg',[]);
        g;
        c2;
        order;
        tpoints;
    ...
    methods
        ...
        function obj = lsfRISDwobbling1inertialNI(params,str,aRFoptions) %constructor function
            if nargin == 0
                super_args = {};
            elseif nargin == 1 
