classdef aRFWAO2Bnd < aRFBnd
    ...
    methods
        function obj = aRFWAO2Bnd(options)
            obj@aRFBnd(options);
        ...
        function obj = setupResponseFunctions(obj)
            ...
            obj.n_diagrams = 6;
            obj.rephasing_diagrams = [1 2 3];
            obj.nonrephasing_diagrams = [4 5 6];
            obj.groundstate_diagrams = [1 2 4 5];
            obj.excitedstate_diagrams = [3 6];
            obj.positive_diagrams = [1 2 4 5];
            obj.negative_diagrams = [3 6 ];
