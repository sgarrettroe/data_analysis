classdef lsfRISDwobbling1inertial1diffNI < lineshapeFunction
    
    properties
        params = struct('Delta_cm',[],'theta0_deg',[],'tr1',[]);
        g;
        c2;
        order;
        tpoints;
    ...
    methods
        ...
        function obj = lsfRISDwobbling1inertial1diffNI(params,str,aRFoptions) %constructor function
            if nargin == 0
                super_args = {};
            elseif nargin == 1 
        ...
        function obj = makeL_l(obj)
            ...
            for l = 1:4
                ...
                Ctot{l}=@(t,p)((S{l}(p.theta0_deg)).^2) ... %inertial cone is just S^2
                    .*exp(-(l*(l+1)./(6.*p.tr1)).*t); %t_m = 1/6D so here tr1 = 1/Dm
                %end
            end
